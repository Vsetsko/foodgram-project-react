    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=128, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator(message='Имя пользователя не соответсвует стандартам Unicode')], verbose_name='Имя пользователя')),
